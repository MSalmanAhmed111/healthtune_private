...
export class AppointmentSessionLinking1757924126135 implements MigrationInterface {
    name = 'AppointmentSessionLinking1757924126135'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "sessions" ADD CONSTRAINT "FK_8ceff81e44b84ed8221c44848f3" FOREIGN KEY ("appointmentId") REFERENCES "session_costing"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
