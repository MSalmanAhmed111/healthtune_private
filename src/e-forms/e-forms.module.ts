...
import { EDocument, User, EDocumentIssuance, Patient, UserPlanUsage } from '@entities';
...
@Module({
  imports: [TypeOrmModule.forFeature([User, EDocument, EDocumentIssuance, Patient, UserPlanUsage]), FileStorageModule],
